...
p <- ggplot(ung_parasites, aes(x = complex2, y = time_to_infectivity, color = hatch)) +
  ...
  geom_point(position = position_jitterdodge(jitter.width = 0.1), alpha = 0.5, size = 1) +
  #scale_y_log10() +
  scale_color_manual(values = mypal) +
  labs(y = "Time to infectivity (degree days)") +
  theme(
...
```{r}
#ggsave(plot = p, filename = "figIb.svg", device = "svg", units = "cm", width = 6, height = 6)
